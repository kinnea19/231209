...
[Personal thanks to Professor Jim Fowler on Coursera for his awesome classes that I really recommend to any math enthusiast and 
...
//   if (n < 3 && n != 0) return [signature[n - 1]];
//   for (let i = 3; i < n; i++) {
